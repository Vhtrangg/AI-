...
def load_model_and_tokenizer():
    ...
    model_file_id = "1BbCjv8WXWmJU1vPtjrSG7ReN-2eKbKnf"  # Thay bằng Google Drive file ID của bạn
    tokenizer_file_id = "1rT6iBWQnqZcP2_eg88P60ccsyes_x7Q2"  # Thay bằng Google Drive file ID của tokenizer
